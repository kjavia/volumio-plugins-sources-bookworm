 ...
 */
export declare function isStationRelevantForArea(station: StationInfo, areaId: string): boolean;
/**
 ...
 */
export declare function isDuplicateAreaFreeStation(station: StationInfo, stationId: string, doneAreaFree: ReadonlySet<string>): boolean;
//# sourceMappingURL=station-filter.d.ts.map