 ...
 */
export declare function resolveAreaIdArray(myAreaId: string | undefined, stationAreaIdArray: readonly string[], selectedAreaIdArray?: readonly string[]): string[];
/**
 ...
 */
export declare function resolveAreaFilter(myAreaId: string | undefined, selectedAreaIdArray: readonly string[]): Set<string> | null;
//# sourceMappingURL=area-resolver.d.ts.map