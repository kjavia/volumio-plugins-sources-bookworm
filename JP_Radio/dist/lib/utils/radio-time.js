...
exports.addDaysToRadioTime = exports.addDaysToDateOnly = exports.formatDateOnly = exports.formatRadioTimeRange = exports.getProgramTimeStatus = exports.isWithinTimeFreeWindow = exports.getTimeSpan = exports.toMinutePrecision = exports.formatHourMinute = exports.formatTimeString = exports.addSecondsToTimeString = exports.revCnvRadioTime = exports.cnvRadioTime = exports.parseRadioTime = exports.getCurrentRadioDate = exports.getCurrentRadioTime = exports.getCurrentDate = exports.getRadioDelay = exports.setRadioDelay = void 0;
/**
 ...
 * @param pattern 書式文字列。
 */
function formatFields(f, pattern) {
 ...
 * @param sec 遅延秒数。
 */
function setRadioDelay(sec) {
    radioDelaySec = sec;
}
exports.setRadioDelay = setRadioDelay;
/**
 * 現在設定されているライブ配信遅延補正値(秒)を返す。
 */
function getRadioDelay() {
    return radioDelaySec;
}
exports.getRadioDelay = getRadioDelay;
...
exports.getCurrentRadioTime = getCurrentRadioTime;
/**
 * 深夜0:00～5:00は前日として扱う「ラジオ日付」を`yyyyMMdd`形式で返す。
 */
function getCurrentRadioDate() {
...
exports.parseRadioTime = parseRadioTime;
/**
 ...
 */
function cnvRadioTime(src, today) {
...
exports.cnvRadioTime = cnvRadioTime;
/**
...
exports.revCnvRadioTime = revCnvRadioTime;
/**
 ...
 * @param t 変換対象の`'yyyyMMddHHmmss'`形式の文字列。
 */
function toMinutePrecision(t) {
    const { date, hour, minute } = parseRadioTime(t);
    return date + hour + minute;
}
exports.toMinutePrecision = toMinutePrecision;
/**
 ...
 * @param end 終了時刻。
 */
function getTimeSpan(begin, end) {
 ...
 */
function isWithinTimeFreeWindow(ft, currentRadioTime) {
    return ft <= currentRadioTime;
}
exports.isWithinTimeFreeWindow = isWithinTimeFreeWindow;
/**
 ...
 * @param currentRadioTime 現在時刻(`getCurrentRadioTime`の戻り値)。
 */
function getProgramTimeStatus(ft, tt, currentRadioTime) {
...
exports.getProgramTimeStatus = getProgramTimeStatus;
/**
 ...
 * @param pattern 表示書式。
 */
function formatRadioTimeRange(ft, tt, pattern) {
...
exports.formatRadioTimeRange = formatRadioTimeRange;
/**
 ...
 */
function formatDateOnly(dateOnly, pattern) {
...
exports.addDaysToDateOnly = addDaysToDateOnly;
/**
 ...
 */
function addDaysToRadioTime(t, days) {
...
exports.addDaysToRadioTime = addDaysToRadioTime;
//# sourceMappingURL=radio-time.js.map